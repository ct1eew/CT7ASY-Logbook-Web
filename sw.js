const CACHE='ct7asy-web-0.1.5';
const FILES=['./','./index.html','./style.css?v=0.1.5','./app.js?v=0.1.5','./adif.js','./map.js','./leaflet.js','./leaflet.css','./LEAFLET-LICENSE.txt','./manifest.webmanifest','./icon.svg','./icon-192.png','./icon-512.png'];
